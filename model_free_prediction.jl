...
# ╔═╡ 275e017d-4af9-4d14-8ab5-4b2c8fb890ce
using PlutoUI

# ╔═╡ 80797905-2e35-4ae2-970a-2ef144a8bf6f
using Plots

# ╔═╡ 093eb51a-59a0-11ed-0596-59331f44b88d
md"""
# Model-Free Prediction
"""

# ╔═╡ 138e5a4a-5827-4aae-9406-131e03ec9f43
md"""
## Random Walk Example
"""

# ╔═╡ 3a9c9569-5c7c-446e-9a8c-bd3ac8375aae
md"""
Resources from [UCL Course on RL](https://www.davidsilver.uk/wp-content/uploads/2020/03/MC-TD.pdf)
"""

# ╔═╡ 4b0cab86-9f2b-4b90-b673-f88687174737
PlutoUI.LocalResource("src/l4_1.png")

# ╔═╡ 1ebfdaa0-2c1b-42be-add9-92390bbf0319
@enum RW_ACTIONS begin
	LEFT = 1
	RIGHT
end

# ╔═╡ e93acb07-aad4-4c53-b005-ca45d42b40e2
RandomWalkEnv = Dict(
	1 => Dict(
		LEFT => [
			(1, 1, 0, true),
...
# ╔═╡ 0baf26e3-f8f6-4145-a95f-d8d0a0b06cc6
begin
	using StatsBase
	function step(state, action)
		transition = sample(1:length(RandomWalkEnv[state][action]),
			Weights(map(x->x[1], RandomWalkEnv[state][action])),
			1)[1] # Note result of sample is a []
		p, next_state, r, done = RandomWalkEnv[state][action][transition]
		return next_state, r, done
	end
end

# ╔═╡ 0d6a7fa1-f304-4288-a809-87aba56a7755
md"""
### Policy Iteration
"""
...
function PolicyIteration(π)
	...
	for iteration in 1:1000
		...
		if v != v_copy
			...
			println("Policy Iteration : policy converged at iteration $iteration")
			break
		end
	end
	return v
...
md"""
From the above plot it is evident that value estimates are not great, probably because the enironment is non-stationary.
"""

# ╔═╡ c24e6947-7f99-45df-897f-cdb248383f21
# Every Visit MC with running mean
function EveryVisitMC(π, α)
	γ = 0.9
	V = zeros(7)
	PLOT = Vector{Vector{Float64}}()
	for episode in 1:1000
...
# ╔═╡ 651d1628-49a1-4b7e-9143-78151a05ef0f
plot(PLOT,
	xlabel="STATE",
